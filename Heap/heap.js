...
export class MinHeap {
    ...
    siftDown(index) {
        ...
        if (left < size && this.compareFn(this.heap[ele], this.heap[left]) > Compare.BIGGER_THAN) {
            ele = left;
        }
        if (right < size && this.compareFn(this.heap[ele], this.heap[right]) > Compare.BIGGER_THAN) {
            ele = right;
        }
        if (index !== ele) {
